...
public class DataInitializer implements CommandLineRunner {
    ...
    public DataInitializer(UsuarioAdminRepository usuarioAdminRepository, PateoRepository pateoRepository, PasswordEncoder passwordEncoder) {
    ...
    private void createTestPateoAdminAndPateo() {
        ...
        if (usuarioAdminRepository.findByEmail(pateoAdminEmail).isEmpty()) {
            ...
            pateoDeTeste.setPlantaBaixaUrl("/images/plantas/planta-pateo-teste.png");
